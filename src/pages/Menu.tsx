    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 md:py-24 bg-orange-50/40 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-6 tracking-tight">
            Our <span className="text-orange-600">Full</span> Menu
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-medium leading-relaxed">
            Explore our complete collection of traditional podis, fresh pacchadis, and daily staples.
          </p>
        </div>
      </section>

      {/* Main Content - No Filters */}
      ...
      <section className="py-20 bg-gray-900 overflow-hidden relative">
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-gray-400 text-lg mb-10 font-medium">We take bulk orders and party catering requests.</p>
          <a
            href="https://wa.me/919347977431"
            className="inline-flex items-center gap-3 px-10 py-5 bg-green-500 text-white font-black rounded-3xl hover:bg-green-600 transition-all shadow-2xl"
          >
